...
JOIN suite_mig_conf.st_adm_tr_grupo_empresa grupo_empresa ON
	empresa.id_empresa = grupo_empresa.id_empresa; -- 74

USE suite_mig_r2d2;

SET @lo_id_grupo_empresa = 73;
...
SET @lo_dir_proveedores = LAST_INSERT_ID();
...
VALUES
(@lo_id_grupo_empresa,'AM'	,1 ,@lo_dir_proveedores,@lo_id_sucursal,NULL,NULL,'INGRESO','M','AME880912I89','Aerovías de México, S.A. de C.V.','Aeroméxico','53274000','mrgetw_tester1@yopmail.com',NULL,NULL,'ACTIVO',NOW(),@lo_id_usuario),
(@lo_id_grupo_empresa,'H00001',5 ,(@lo_dir_proveedores+1),@lo_id_sucursal,NULL,NULL,'INGRESO','M','HTR020506EF8','Hoteles de México, S.A. de C.V.','Hoteles de México','44-44-44-44','mrgetw_tester1@yopmail.com',NULL,NULL,'ACTIVO',NOW(),@lo_id_usuario),
(@lo_id_grupo_empresa,'S00001',12,(@lo_dir_proveedores+2),@lo_id_sucursal,NULL,NULL,'INGRESO','M','ASV061005KL2','Asistencia en Viajes, S.A. de C.V.','Asistencia en Viajes','66-66-66-66','mrgetw_tester1@yopmail.com',NULL,NULL,'ACTIVO',NOW(),@lo_id_usuario),
(@lo_id_grupo_empresa,'O00001',11,(@lo_dir_proveedores+3),@lo_id_sucursal,NULL,NULL,'INGRESO','M','OPK170301WYZ','Operadora Kanguro, S.A. de C.V.','Operadora Kanguro','55-55-55-55','mrgetw_tester1@yopmail.com',NULL,NULL,'ACTIVO',NOW(),@lo_id_usuario),
(@lo_id_grupo_empresa,'A00001',6 ,(@lo_dir_proveedores+4),@lo_id_sucursal,NULL,NULL,'INGRESO','M','AUT160814LK5','Hodge Arrendadora de Autos, S.A. de C.V.','Hodge Arrendadora','22-22-22-22','mrgetw_tester1@yopmail.com',NULL,NULL,'ACTIVO',NOW(),@lo_id_usuario),
(@lo_id_grupo_empresa,'C00001',7 ,(@lo_dir_proveedores+5),@lo_id_sucursal,NULL,NULL,'INGRESO','M','ETN861001FD5','Enlaces Terrestres Nacionales, S.A. de C.V.','ETN','66-66-66-66','mrgetw_tester1@yopmail.com',NULL,NULL,'ACTIVO',NOW(),@lo_id_usuario),
(@lo_id_grupo_empresa,'R00001',8 ,(@lo_dir_proveedores+6),@lo_id_sucursal,NULL,NULL,'INGRESO','M','CRU96011815E','Cruceros Espectaculares, S.A. de C.V.','Cruceros Espectaculares','77-77-77-77','mrgetw_tester1@yopmail.com',NULL,NULL,'ACTIVO',NOW(),@lo_id_usuario),
(@lo_id_grupo_empresa,'N00001',3 ,(@lo_dir_proveedores+7),@lo_id_sucursal,NULL,NULL,'INGRESO','M','CVI050520896','Consolidadora de Viajes, S.A. de C.V.','Consolidadora de Viajes','88-88-88-88','mrgetw_tester1@yopmail.com',NULL,NULL,'ACTIVO',NOW(),@lo_id_usuario),
(@lo_id_grupo_empresa,'X00001',12,(@lo_dir_proveedores+8),@lo_id_sucursal,NULL,NULL,'INGRESO','F','XAXX010101000','Cargos por Servicio','Cargos por Servicio','66-66-66-66','mrgetw_tester1@yopmail.com',NULL,NULL,'ACTIVO',NOW(),@lo_id_usuario),
(@lo_id_grupo_empresa,'F00001',10,(@lo_dir_proveedores+9),@lo_id_sucursal,NULL,NULL,'INGRESO','M','FNO080615GE2','Ferrocarriles del Noreste, S.A. de C.V.','Ferrocarriles del Noreste','22-22-22-22','mrgetw_tester1@yopmail.com',NULL,NULL,'ACTIVO',NOW(),@lo_id_usuario);
...
WHERE id_producto = 1
AND id_grupo_empresa = @lo_id_grupo_empresa;
...
FROM ic_cat_tc_servicio
WHERE id_producto = 2
AND id_grupo_empresa = @lo_id_grupo_empresa; -- 6
...
VALUES
('MX', 'Jalisco', '77', '', 'Roma Norte', 'Cuauhtémoc', 'Ciudad de México', 'CIUDAD DE MEXICO', '06700', 'ACTIVO'),
('MX', 'Paseo de la Reforma', '243', '', 'Cuauhtémoc', 'Cuauhtémoc', 'Ciudad de México', 'CIUDAD DE MEXICO', '06500', 'ACTIVO'),
('MX', 'Ganges', '45', 'PB', 'Cuauhtémoc', 'Cuauhtémoc', 'Ciudad de México', 'CIUDAD DE MEXICO', '06500', 'ACTIVO');

SET @lo_dir_cliente = LAST_INSERT_ID();
...
VALUES 
	(@lo_id_grupo_empresa,@lo_id_sucursal,@lo_id_corporativo,@lo_id_vendedor,@lo_dir_cliente,NULL,'ABCD010203AB','001','Periódicos y revistas de México, S.A, de C.V.','M','Periódicos y revistas de México','FIJO','55-55-55-55','mrgetw_tester1@yopmail.com','',0,'','0','0','0','','','0',8,NULL,180288.60,'N','N','N','N','N','N','1','0',NOW(),'ACTIVO',NOW(),@lo_id_usuario),
	(@lo_id_grupo_empresa,@lo_id_sucursal,@lo_id_corporativo,@lo_id_vendedor,(@lo_dir_cliente+1),NULL,'DEFG02030425','HILGAT','Hilos el Gato, S.A. de C.V.','M','Hilos el Gato, S.A. de C.V.','FIJO','66-66-66-66','mrgetw_tester1@yopmail.com','',0,'','0','0','0','','','0',15,NULL,437010.00,'N','N','N','N','N','N','1','0',NOW(),'ACTIVO',NOW(),@lo_id_usuario),
	(@lo_id_grupo_empresa,@lo_id_sucursal,@lo_id_corporativo,(@lo_id_vendedor+1),(@lo_dir_cliente+2),NULL,'IHG8611053F3','IHG8611053','Industrias de Hule González, S.A. de C.V.','M','Industrias de Hule González,','FIJO','55-55-55-55','mrgetw_tester1@yopmail.com','',0,'','0','0','0','','','0',3,NULL,14280.00,'N','N','N','N','N','N','N','0',NOW(),'ACTIVO',NOW(),@lo_id_usuario);
