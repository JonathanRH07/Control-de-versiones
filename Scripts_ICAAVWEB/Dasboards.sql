...
/* DASH 1 */
CALL sp_dash_administrador_indicadores_c(7, @pr_message);
SELECT @pr_message;

/* DASH 1 */
CALL sp_dash_administrador_graf_comparativa_x_tipo_prov_c(7, 98, 100, @pr_message);
SELECT @pr_message;

/* DASH 1 */
CALL sp_dash_administrador_graf_comparativa_x_vendedor_c(7, 98, 100, @pr_message);
SELECT @pr_message;

/* DASH 1 */
CALL sp_dash_administrador_graf_boletos_x_tc_c(7, 98, @pr_message);
SELECT @pr_message;

/* DASH 1 */
CALL sp_dash_administrador_contenido_promedio_x_cliente_c(7, 98, 100, 0, 5, @pr_rows_tot_table, @pr_message);
SELECT @pr_rows_tot_table, @pr_message;

/* DASH 1 */
CALL sp_dash_administrador_contenido_promedio_x_cxs_c(7, 98, 100, 0, 100, @pr_rows_tot_table, @pr_message);
SELECT @pr_rows_tot_table, @pr_message;

/* DASH 1 */
CALL sp_dash_administrador_contenido_promedio_x_vededor_c(7, 98, 100, 0, 100, @pr_rows_tot_table, @pr_message);
SELECT @pr_rows_tot_table, @pr_message;



/* DASH 2 */sp_sat_bancos_u
CALL sp_dash_administrador_indicadores2_c(7, @pr_message);
SELECT @pr_message;

/* DASH 2 */
CALL sp_dash_administrador_graf_folios_x_mes_c(10, @pr_message);
SELECT @pr_message;

/* DASH 2 */
CALL sp_dash_administrador_contenido_usuarios_conectados_c(7, 0, 10, @pr_rows_tot_table, @pr_message);
SELECT @pr_rows_tot_table, @pr_message;

/* DASH 2 */
CALL sp_dash_administrador_contenido_usuarios_ult_conexion_c(7, 0, 10, @pr_rows_tot_table, @pr_message);
SELECT @pr_rows_tot_table, @pr_message;
