DELIMITER $$
CREATE DEFINER=`suite_deve`@`%` PROCEDURE `sp_cat_config_banco_cg`(
...
/*
	...
	@fecha: 		05/03/2018
	@descripcion: 	SP para buscar registros en qualquier campo por texto o carácter Alfanumérico en la tabla ic_cat_tr_config_banco
...
*/
	...
	SET @query = CONCAT('SELECT
							...
							id_usuario
						FROM
							suite_mig_conf.st_adm_tr_config_banco
