DELIMITER $$
CREATE DEFINER=`suite_deve`@`%` PROCEDURE `sp_adm_config_banco_f`(
...
BEGIN
/*
	@nombre: 		sp_cat_config_banco_f
	@fecha: 		05/03/2018
	@descripcion: 	SP para filtrar registros en la tabla ic_cat_tr_config_banco
...
*/
    ...
    BEGIN
        SET pr_message = 'ERROR store sp_cat_config_banco_f';
	END ;
