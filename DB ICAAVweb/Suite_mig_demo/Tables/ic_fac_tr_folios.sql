CREATE TABLE `ic_fac_tr_folios` (
  ...
  KEY `fk_grupo_empresa_idx` (`id_grupo_empresa`),
  KEY `idx_metodo_pago` (`metodo_pago`),
  CONSTRAINT `fk_grupo_empresa` FOREIGN KEY (`id_grupo_empresa`) REFERENCES `suite_mig_conf`.`st_adm_tr_grupo_empresa` (`id_grupo_empresa`) ON DELETE NO ACTION ON UPDATE NO ACTION
