DELIMITER $$
CREATE DEFINER=`suite_deve`@`%` PROCEDURE `sp_cat_cliente_banco_c`(
...
*/
    ...
    LEFT JOIN sat_bancos ON
		sat_bancos.id_sat_bancos = ic_cat_tr_cliente_banco.id_sat_bancos
	LEFT JOIN ic_glob_tr_forma_pago ON
		ic_glob_tr_forma_pago.id_forma_pago = ic_cat_tr_cliente_banco.id_forma_pago
