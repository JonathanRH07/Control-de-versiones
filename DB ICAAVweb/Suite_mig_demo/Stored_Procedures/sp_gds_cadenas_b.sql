DELIMITER $$
CREATE DEFINER=`suite_deve`@`%` PROCEDURE `sp_gds_cadenas_b`(
...
BEGIN
/*
	@nombre: 		sp_gds_cadenas_b
	@fecha: 		06/04/2018
	@descripcion: 	SP para buscar registros en qualquier campo por texto o carácter Alfanumérico en la tabla ic_gds_tr_cadenas
...
*/
    ...
    BEGIN
        SET pr_message = 'ERROR store sp_gds_cadenas_b';
	END ;
