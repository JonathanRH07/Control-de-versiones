DELIMITER $$
CREATE DEFINER=`suite_deve`@`%` PROCEDURE `sp_adm_ob_permisos_sistemas_empresa_c`(
	-- IN  pr_id_usuario 	INT,
	IN	pr_id_empresa	INT,
	OUT pr_message 		VARCHAR(250))
BEGIN
/*
	@SPName: 			sp_adm_ob_permisos_sistemas_empresa_c
	@date: 				2016/09/02
...
DECLARE EXIT HANDLER FOR SQLEXCEPTION
	BEGIN
		SET pr_message = 'ERROR store sp_adm_ob_permisos_sistemas_empresa_c';
	END;
    ...
    AND*/ gem.id_empresa = pr_id_empresa;
