...
*/
    ...
    SET @query_promedio_x_cxs = CONCAT(
									'
                                    SELECT
	...
	-- SELECT @query_promedio_x_cxs;
	PREPARE stmt FROM @query_promedio_x_cxs;
	EXECUTE stmt;
	...
	SET @query_promedio_cxs_tot = CONCAT(
									'
                                    SELECT
										COUNT(*)
									INTO
	...
	-- SELECT @query_promedio_cxs_tot;
	PREPARE stmt FROM @query_promedio_cxs_tot;
	EXECUTE stmt;
    DEALLOCATE PREPARE stmt;
