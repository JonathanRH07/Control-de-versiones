DELIMITER $$
CREATE DEFINER=`suite_deve`@`%` PROCEDURE `sp_cat_forma_pago_b`(
...
BEGIN
	/*
		...
		@fecha:			02/12/2016
		@descripcion:	SP para buscar registros en qualquier campo por texto o carácter Alfanumérico en catalogo forma de pago.
	...
	*/
	...
	SET @query = CONCAT('
			...
			FROM ic_glob_tr_forma_pago AS mp
