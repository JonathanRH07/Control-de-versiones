DELIMITER $$
CREATE DEFINER=`suite_deve`@`%` PROCEDURE `sp_cat_servicio_impuesto_x`(
...
*/
	...
	BEGIN
		SET pr_message = 'ERROR store sp_cat_servicio_impuesto_x';
...
select 1;
		...
		ELSE
			INSERT INTO ic_fac_tr_servicio_impuesto(id_servicio, id_impuesto)
