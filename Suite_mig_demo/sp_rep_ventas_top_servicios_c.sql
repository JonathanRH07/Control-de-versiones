DELIMITER $$
CREATE DEFINER=`suite_deve`@`%` PROCEDURE `sp_rep_ventas_top_servicios_c`(
...
BEGIN
/*
	@nombre:		sp_rep_ventas_top_servicios_c
	@fecha:			10/08/2018
...
*/
    ...
    BEGIN
        SET pr_message = 'ERROR store sp_rep_ventas_top_servicios_c';
	END ;
